...
const energyBaseFields = {
    ...
    emissionCategory : AvEmissionCategoryTextField( 3 )( { required : false, label : "GHG Emission Category", } ),
} as { [index in TravelEntryFlatfileRecordKeys] : AnyField };

export const AvTravelSheet = new Sheet( 'Travel Sheet', energyBaseFields,{
